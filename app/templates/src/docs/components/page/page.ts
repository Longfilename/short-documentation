...
const $page = $('.page');
const $frame = $('.page__frame');
const click = 'touchstart.page click.page';
const transitionEnd = 'transitionend.page';
const animateClass = 'page--animate';
const modalClass = 'page--modalview';
